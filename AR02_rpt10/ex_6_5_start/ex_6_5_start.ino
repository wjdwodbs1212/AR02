...
void loop(){
  ...
  if(zValue == LOW){
    digitalWrite(wShoot,HIGH);
  }
  else digitalWrite(wShoot,LOW);
 if(xDisplay<10) {
 digitalWrite(yRight,HIGH);
 }
 else digitalWrite(yRight,LOW);
 
 if(xDisplay>10){digitalWrite(yLeft,HIGH);
 }
 else digitalWrite(yLeft,LOW);
 
 if(yDisplay<10){digitalWrite(bGo,HIGH);
 }
 else digitalWrite(bGo,LOW);

 if(yDisplay>10){ digitalWrite(rStop,HIGH);
 }
 else digitalWrite(rStop,LOW);
